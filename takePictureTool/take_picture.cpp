...
int main(){
    ...
    for(int i=0; i<100; i++){
        ...
        cap >> image;
        std::string filename = "/home/user3057/workspace/project/test_data/test_bad/jpg/test_bad_" + std::to_string(i) + ".jpg";

        if (!image.empty()) {
            cv::imwrite(filename, image);
            std::cout << "사진을 저장했습니다." << std::endl;
        ...
        // 결과를 저장합니다.
        std::string filename2 = "/home/user3057/workspace/project/test_data/test_bad/canny/test_bad_"+ std::to_string(i) + ".jpg";
